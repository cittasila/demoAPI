 ...
 */
public class RedisCacheManagerExt extends AbstractTransactionSupportingCacheManager {
    private final Log logger = LogFactory.getLog(RedisCacheManagerExt.class);
     ...
     */
    @SuppressWarnings("rawtypes")
    public RedisCacheManagerExt(RedisOperations redisOperations) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public RedisCacheManagerExt(RedisOperations redisOperations, Collection<String> cacheNames) {
    ...
    protected RedisCacheExt createCache(String cacheName) {
        long expiration = computeExpiration(cacheName);
        return new RedisCacheExt(cacheName, (usePrefix ? cachePrefix.prefix(cacheName) : null), redisOperations, expiration);
    }
