...
public class HttpsRequest{
    ...
    public  DefaultHttpClient wrapClient() {
        try {
    ...
    public String sendXmlPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
