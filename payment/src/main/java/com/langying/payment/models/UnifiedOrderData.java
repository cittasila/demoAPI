...
import com.langying.payment.common.Util;
...
public class UnifiedOrderData {
    ...
    public UnifiedOrderData(String outTradeNo,String body,Integer totalFee,String spBillCreateIP,String timeStart,String attach,String notifyUrl) {
       ...
       // setTime_expire();
        ...
        //订单失效时间，格式同上
        setTime_expire(Util.addSeconds(timeStart,5));
